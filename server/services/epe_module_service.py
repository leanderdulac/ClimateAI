...
def calculate_commercial_pricing(risk_adjusted_premium: RiskAdjustedPremium, 
    ...
    return epe_engine.calculate_commercial_pricing(risk_adjusted_premium, market_data, pricing_strategy)
...
def calculate_dynamic_pricing_factors(customer_profile: Dict[str, Any],
    ...
    return epe_engine.calculate_dynamic_pricing_factors(customer_profile, policy_features)
...
def get_pricing_strategy_recommendation(market_data: MarketData,
    ...
    return epe_engine.get_pricing_strategy_recommendation(market_data, portfolio_metrics)