...
class ParametricInsuranceService:
    ...
    def calculate_wind_index(
        self, wind_speed_3s_gusts: List[float], threshold: float = 20.0
    ) -> List[float]:
        """
    ...
    def calculate_precipitation_index(
        self, precipitation_24h: List[float], threshold: float = 50.0
    ) -> List[float]:
        """
    ...
    def calculate_temperature_index(
        self, temperature_data: List[float], threshold: float = 35.0
    ) -> List[float]:
        """
    ...
    def calculate_composite_index(
        ...
        """
        if not all(
            len(lst) == len(wind_indices) for lst in [precip_indices, temp_indices]
        ):
    ...
    def optimize_trigger(
        ...
        trigger_bounds: Tuple[float, float] = (0.0, None),
    ) -> Dict[str, Any]:
        """
        ...
        try:
            result = minimize_scalar(
                objective_function, bounds=trigger_bounds, method="bounded"
            )
            ...
            return {
                ...
                "payout_loss_error": np.mean(
                    [(p - l) ** 2 for p, l in zip(optimal_payouts, losses)]
                ),
            }
    ...
    def calculate_parametric_insurance_contract(
        ...
        optimize_trigger_flag: bool = True,
    ) -> Dict[str, Any]:
        """
        ...
        precip_indices = self.calculate_precipitation_index(
            precipitation_24h, precip_threshold
        )
        temp_indices = self.calculate_temperature_index(
            temperature_data, temp_threshold
        )
        ...
        if optimize_trigger_flag or trigger is None:
            ...
            opt_result = {
                ...
                "payout_loss_error": np.mean(
                    [(p - l) ** 2 for p, l in zip(payouts, actual_losses)]
                ),
            }
...
def calculate_wind_index(
    wind_speed_3s_gusts: List[float], threshold: float = 20.0
) -> List[float]:
    """Calculate maximum sustained wind index (3-second gusts)"""
    return parametric_insurance_service.calculate_wind_index(
        wind_speed_3s_gusts, threshold
    )


def calculate_precipitation_index(
    precipitation_24h: List[float], threshold: float = 50.0
) -> List[float]:
    """Calculate accumulated precipitation index (24h)"""
    return parametric_insurance_service.calculate_precipitation_index(
        precipitation_24h, threshold
    )


def calculate_temperature_index(
    temperature_data: List[float], threshold: float = 35.0
) -> List[float]:
    """Calculate consecutive high temperature index"""
    return parametric_insurance_service.calculate_temperature_index(
        temperature_data, threshold
    )
