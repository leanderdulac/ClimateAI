...
class TokenizationService:
    ...
    def _initialize_service(self) -> None:
        ...
        try:
            ...
            if self.w3 and not self.w3.is_connected():
                raise ConnectionError(f"Could not connect to Blockchain Node at {node_url}")
            ...
            if contract_address and abi_json and self.w3:
                ...
                logger.warning("Contract address or ABI missing. Contract interaction disabled.")

        except Exception as e:
            logger.error(f"Failed to initialize Blockchain service: {e}. Switching to MOCK mode.")
            self.mock_mode = True
            self.w3 = None
            self.contract = None
    ...
    def mint(self, to: str, amount: int) -> Any:
        ...
        try:
            ...
            signed = w3_instance.eth.account.sign_transaction(tx, private_key=private_key)
