...
async def get_compliance_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving compliance report: {str(e)}")
...
async def add_compliance_rule(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error adding compliance rule: {str(e)}")
...
async def get_compliance_rules(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving compliance rules: {str(e)}")