            ...
            async with aiohttp.ClientSession() as session:
                ...
                try:
                    async with session.get(
                        ...
                        api_results["open_meteo"] = "healthy" if resp.status == 200 else "unhealthy"
                except Exception as e:
...
class HealthChecker:
    ...
    async def check_all(self) -> Dict[str, Any]:
        ...
        for i, result in enumerate(check_results):
            ...
            elif result.status == ServiceStatus.DEGRADED and overall_status != ServiceStatus.UNHEALTHY:
...
async def get_health_checker(database_url: str = None, redis_url: str = None) -> HealthChecker:
